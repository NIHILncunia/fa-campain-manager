...
var command = {
    ...
    execute: function (client, interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var campainName, findCampain, embed_1, updateCampain, sessions, embed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_1.campain.update({
                                where: {
                                    id: findCampain.id,
                                },
                                data: {
                    ...
                    case 3:
                        ...
                        embed = new discord_js_1.EmbedBuilder()
                            ...
                            {
                                name: '캠페인 종료',
                                value: "[".concat(updateCampain.name, "] \uCEA0\uD398\uC778\uC774")
                                    + "**".concat(sessions.length, "**\uBC88\uC758 \uC138\uC158\uC744 \uC9C4\uD589\uD558\uACE0 \uC885\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4."),
                            },
                        ]);
                        interaction.reply({
                            embeds: [embed,],
